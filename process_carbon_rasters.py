...
CARBON_EDGE_MODEL_DATA_NODATA = [
    ...
    ('population_2015_5min_compressed_md5_4c267e3cb681689acc08020fd64e023d.tif', None),
...
def main():
    ...
    LOGGER.info('mask out LULC rasters for forest and ag')
    LOGGER.info('create convolutions for those masks...')
