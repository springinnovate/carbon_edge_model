...
def main():
    ...
    for name, reg in [
            ...
            ('LassoLars', make_pipeline(poly_features, StandardScaler(), PCA(n_components=n_predictors), linear_model.LassoLarsCV(alpha=.1, normalize=False, max_iter=max_iter, eps=1e-3))),
            ]:
