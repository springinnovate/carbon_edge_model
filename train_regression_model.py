...
def main():
    ...
    for name, reg in [
            ('LinearSVR_v2', make_pipeline(poly_features, StandardScaler(), LinearSVR(max_iter=max_iter, loss='squared_epsilon_insensitive', epsilon=1e-4, dual=False))),
        ...
        model = reg.fit(trainset[0], trainset[1], sample_weight=trainset[1]/max(trainset[1]))
